...
Original file is located at
    https://colab.research.google.com/drive/1vKM3Hu6R6hRvFo41mQP0-hzQ9gRKDot-
"""
...
def main():
    ...
    pdf_path = os.path.join(my_directory, f"Hemicampo {nombre_archivo} _ {formatted_datetime}.pdf")
